...
public class PolylineEncoder {
	 ...
	 */
	public static EncodedPolylineBean createEncodings(
			Iterable<Coordinate> points, int level) {
	...
	private static class PointAdapterList extends AbstractList<Coordinate> {
		...
		public PointAdapterList(double[] lat, double[] lon, int offset,
				int length) {
			_lat = lat;
			_lon = lon;
			_offset = offset;
